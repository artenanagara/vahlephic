  ...
  return (
    <footer className="flex w-full flex-col gap-4">
      ...
      <div className="flex flex-col gap-3 min-[420px]:flex-row min-[420px]:items-center min-[420px]:justify-between">
        <p className={`font-light text-base leading-5.5 ${muted} opacity-80`}>
          vahlephic ⓒ 2026
        </p>

        <div className="flex items-center gap-2">
          <a href="https://www.instagram.com/vahlephic/" target="_blank" rel="noopener noreferrer"
             className="bg-[rgba(43,43,43,0.05)] p-1.25 rounded-full transition-transform duration-150 hover:scale-110 active:scale-95">
          ...
          <a href="https://dribbble.com/vahlephic" target="_blank" rel="noopener noreferrer"
             className="bg-[rgba(43,43,43,0.05)] p-1.25 rounded-full overflow-hidden transition-transform duration-150 hover:scale-110 active:scale-95">
            {/* eslint-disable-next-line @next/next/no-img-element */}
